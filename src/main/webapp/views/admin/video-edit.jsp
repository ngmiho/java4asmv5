				...
				<div class="row">
					<div class="col-9">
						<div class="row">
							<div class="col-12 form-group">
								...
								<textarea id="detail" class="form-control" rows="4">${video != null ? video.detail : ''}</textarea>
							</div>
							<div class="col-12 form-group">
								<label for="poster">Poster</label>
								<input type="text" id="poster" value="${video != null ? video.href : ''}" class="form-control">
					...
					<div class="col-3">
						...
						<div style="width: 100%; height: 200px; border: 1px dotted gray">
							<img id="imgPreview" src="${video != null ? 'video.href' : ''}" height="100%" width="100%" />
						</div>
					</div>
				</div>
...
<script>
	var titleOrigin, hrefOrigin, detailOrigin, posterOrigin;
	$(document).ready(function() {
		titleOrigin = $('#title').val();
		hrefOrigin = $('#href').val();
		detailOrigin = $('#detail').val();
	...
	$('#submitBtn').click(function() {
		...
		if (isEdit === 'true') {
			url = '/java4asmv5/admin/video?action=edit&href=' + hrefOrigin;
		} else {
			url = '/java4asmv5/admin/video?action=add';
		}
		var formData = {
		...
		$.ajax({
			...
			window.location.href = "http://localhost:8080/java4asmv5/admin/video?action=view";
		}).fail(function(error){
	...
	//https://img.youtube.com/vi/E6qYeMpNgz4/maxresdefault.jpg
</script>
</body>
</html>